...
import "../assets/PrivacyPolicy/PrivacyPolicy.css";
  ...
  render() {
    return (
      <div className="pp_main container App_Page">
        ...
        <p>
          Your privacy is important to us. It is Worldesports Earnings' policy
          to respect your privacy regarding any information we may collect from
          you across our website, http://worldesportsearnings.com, and other
          sites we own and operate. We only ask for personal information when we
          ...
          This policy is effective as of 5 January 2020. Privacy Policy created
          with GetTerms.{" "}
        </p>
      </div>
    );
